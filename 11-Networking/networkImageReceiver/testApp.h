...
/*
This example demonstrates receiving images via network using TCP protocol.
Run it together with networkImageSender.

It's the example 11-Networking/networkImageReceiver from the book 
